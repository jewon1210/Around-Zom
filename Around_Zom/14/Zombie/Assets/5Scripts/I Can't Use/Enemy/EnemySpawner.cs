...
public class EnemySpawner : MonoBehaviour {
    ...
    private void Update() {
        ...
        if (wave ==3 && enemies.Count<=0 && !BossSpawned)
        {
            StageBossSpawn();
            BossSpawned = true;
        }

        if(enemies.Count == 0 && BossSpawned && IsBossDead == false)
        {
            IsBossDead = true;
    ...
    IEnumerator StageDelay()
    {
        ...
        //Scene_Manager.control.Go_Stage2();
    }
    ...
    void StageBossSpawn()
    {
        ...
        Color skinColor = new Color(0.1616085f, 0.2358491f, 0.01446245f);
